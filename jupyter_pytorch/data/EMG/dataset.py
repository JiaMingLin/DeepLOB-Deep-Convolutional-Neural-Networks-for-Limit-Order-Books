...
class EGMDataset(data.Dataset):
    def __init__(self, train = True):
        self.parent_dir = './data/EMG/processed'
        self.train = train
...
def emg_dataset(batch_size=64):
    train_dataset = EGMDataset(train = True)
    valid_dataset = EGMDataset(train = False)
    ...
    return train_loader, valid_loader, test_loader, tmp_loader
